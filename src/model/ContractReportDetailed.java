...
public class ContractReportDetailed extends Report {
	...
	public String generateReport() {
		if (getCompany().findContract(id) != null) {
			...
			if (isToCsv()) {
				report += "empresa,empleado,nombre,id,tipo,descripci�n,clausulas,cantidad,fecha_inicio,fecha_fin,fecha_radicaci�n,renovaciones_actuales,limite_de_renovaciones\n";
			...
			report += "Fecha de terminaci�n: " + (finishDate != null ? finishDate.toString() : "N/A") + "\n";
			report += "Fecha de radicaci�n: " + (radicationDate != null ? radicationDate.toString() : "N/A") + "\n";
